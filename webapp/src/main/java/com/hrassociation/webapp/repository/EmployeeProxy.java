...
import com.hrassociation.webapp.configuration.CustomProperties;
...
public class EmployeeProxy {
  ...
  public Employee createEmployee(Employee e) {
    String baseApiUrl = props.getApiUrl();
    String createEmployeesUrl = baseApiUrl + "/employees";
  ...
  public Employee updateEmployee(Employee e) {
    String baseApiUrl = props.getApiUrl();
    String updateEmployeesUrl = baseApiUrl + "/employees/" + e.getId();
  ...
  public void deleteEmployee(final Long id) {
    String baseApiUrl = props.getApiUrl();
    String deleteEmployeesUrl = baseApiUrl + "/employees/" + id;
